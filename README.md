...
- Clinical text is difficult to classify effectively. Understanding the context of words is key but it is not easy to find related word embeddings. We settled for using static word embeddings which do not take into account the use of words within our specific context, and obtained relatively poor performance in our alternative model.
